...
public class BookController {
    ...
    public ResponseEntity<Book> updateBook(@PathVariable("id") Long id, @RequestBody BookDTO updatedBook)
        ...
        existingBook.setCategory(bookToSave.getCategory()); // Si la relation est `ManyToOne`

      

        Book savedBook = bookService.updateBook(id, existingBook);
    ...
    // public ResponseEntity<Object> getBookByCode(@PathVariable("code") String
    // code) {
    ...
    // return new ResponseEntity<>(bookService.getAllBooksSortedByPrice(),
    // HttpStatus.OK);
    // }
...
//     // public ResponseEntity<?> getBookById(@PathVariable Long id) {
//     // BookDTO category
//     // =CategoryDTO.toCategoryDTO(this.categoryService.getCategoryById(id));
...
//     // @PutMapping("/{id}")
//     // public ResponseEntity<?> updateBook(@PathVariable("id") Long id, @RequestBody
//     // BookDTO bookDTO) {
//     // Book book = BookDTO.fromBookDTO(bookDTO);
//     // bookService.getBookById(id);

//     // return new ResponseEntity<>(this.bookService.updateBook(id,book),
//     // HttpStatus.OK);

//     // // return new ResponseEntity<>("Failed: Product not found",
...
//     // public ResponseEntity<?> getBooksByCategoryId(@PathVariable("categoryId")
//     // Long categoryId) {

//     // return new ResponseEntity<>("Failed: Category not found",
//     // HttpStatus.NOT_FOUND);
//     // }
